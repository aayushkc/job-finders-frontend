export default function AccountActivationSucess(){
    return(<>
    <div
            ...
            <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
                ...
                <div className="my-8 text-center">
                    ...
                    <h4 className="text-xl text-gray-800 font-semibold mt-4">Successfully Sent!</h4>
                    <p className="text-sm text-gray-500 leading-relaxed mt-4">A reset link has been sent successfully.</p>
                </div>
